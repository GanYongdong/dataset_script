...
if platform.system().lower() == 'windows':
    ...
    print("linux")
    txt_dir = '/media/ganyd/0C26A92126A90D30/Research/My_tamper_detect_dataset_generate' \
              '/6dataset_irregular_png_06resize_3x3kernel_8class/yolo_label_xml '

# 获取目录下所有目录与文件名称
fileNameList = os.listdir(txt_dir)
txt_file = "D:\\Research\\My_tamper_detect_dataset_generate\\dataset_tmp\\voc_dataset\\all_pic_name.txt"
