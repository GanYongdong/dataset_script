...
# 输出txt文件路径
dst_train_path = root_dir + 'voc_dataset\\ImageSets\\Main\\train.txt'
dst_valid_path = root_dir + 'voc_dataset\\ImageSets\\Main\\valid.txt'
dst_test_path = root_dir + 'voc_dataset\\ImageSets\\Main\\test.txt'
dst_all_path = root_dir + 'voc_dataset\\ImageSets\\Main\\all.txt'
# 比例
train_ratio = 0.9
